...
![[Pasted image 20251118142326.png]]
...
- A clean topology diagram for your exact Workstation → ESXi → OPNsense design
    
- A step-by-step ESXi + Workstation hybrid setup
    
- A troubleshooting checklist for Suricata visibility issues
